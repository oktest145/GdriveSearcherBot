...
INDEX_URL = list(set(x for x in os.environ.get("INDEX_URL", "https://drive-index.gujjuironman.workers.dev/0: https://drive-index.gujjuironman.workers.dev/1: https://drive-index.gujjuironman.workers.dev/2: https://drive-index.gujjuironman.workers.dev/3: https://drive-index.gujjuironman.workers.dev/4:").split()))
